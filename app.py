...
<style>
    ...
    /* 播放按钮 */
    .play-btn { background: #2ea043; color: white; border: none; border-radius: 4px; padding: 6px 15px; cursor: pointer; font-size: 0.95rem; transition: 0.2s; box-shadow: 0 2px 5px rgba(0,0,0,0.3); vertical-align: middle;}
    .play-btn:hover { background: #3fb950; transform: scale(1.05); }

    /* --- 无痕防作弊翻译 (同背景色，悬停变金) --- */
    .hidden-tr { color: #161b22; transition: color 0.3s ease; cursor: default; user-select: none; font-weight: bold; background: #161b22; border-radius: 4px; padding: 2px 5px;}
    .hidden-tr:hover { color: #fbbf24; background: transparent; }

    /* --- 词性色彩罗盘 (符合主编要求) --- */
    .pos-verb { color: #ff7b72; font-weight: bold; border-bottom: 2px solid #ff7b72; padding-bottom: 1px;} 
    .pos-adv { color: #79c0ff; font-weight: bold; border-bottom: 2px solid #79c0ff; padding-bottom: 1px;} 
    .pos-conj { color: #d2a8ff; font-weight: bold; border-bottom: 2px solid #d2a8ff; padding-bottom: 1px;} 
    .pos-pron { color: #2ea043; font-weight: bold; border-bottom: 2px solid #2ea043; padding-bottom: 1px;} 
    .pos-adj { color: #ffa657; font-weight: bold; border-bottom: 2px solid #ffa657; padding-bottom: 1px;} 
    .pos-noun { color: #a5d6ff; font-weight: bold; border-bottom: 2px solid #a5d6ff; padding-bottom: 1px;} 
    ...
    .mm-note { font-size: 1rem; color: #8b949e; margin-bottom: 10px; background: #161b22; padding: 8px; border-radius: 4px; border-left: 3px solid #79c0ff;}
    ...
    /* 悬浮硬核解析框 (Tooltip) */
    .floating-box { position: absolute; background: #0d1117; border: 1px solid #30363d; border-top: 4px solid #fbbf24; border-radius: 8px; padding: 25px; width: 680px; box-shadow: 0 10px 40px rgba(0,0,0,0.9); z-index: 1000; display: none; pointer-events: none; }
...
<script>
    ...
    function onSenEnter(e, id) {
        ...
        // 动态计算，保证悬浮窗贴在鼠标下方
        floatBox.style.top = (e.pageY + 35) + 'px';
        floatBox.style.left = Math.max(20, e.pageX - 340) + 'px'; 
    }
...
l1_words = [
    {"word": "捗る", "kana": "はかどる", "direct_tr": "进展顺利", "usages": [
        {"meaning": "用法①：事物或工作顺利进展", "jp": "計画が予定通りに捗っている。", "pure": "けいかくがよていどおりにはかどっている", "tr": "计划正按预期顺利进行。", "note": "【N2考点】常与「仕事」「勉強」等搭配。"},
        {"meaning": "用法②：搭配副词（とても/順調に）", "jp": "今日は涼しいので、勉強がとても捗る。", "pure": "きょうはすずしいので、べんきょうがとてもはかどる", "tr": "今天很凉快，所以学习效率非常高。", "note": "【辨析】强调“速度快、效率高”，区别于「進む」(单纯的前进)。"}
    ]},
    {"word": "割り当てる", "kana": "わりあてる", "direct_tr": "分配/分摊", "usages": [
        {"meaning": "用法①：分配任务给具体的人", "jp": "新入社員に簡単な仕事を割り当てる。", "pure": "しんにゅうしゃいんにかんたんなしごとをわりあてる", "tr": "把简单的工作分配给新员工。", "note": "【近义词辨析】「分ける」是单纯分开，「割り当てる」强调按责任或比例分配。"},
        {"meaning": "用法②：分配物理资源", "jp": "一部屋に二人ずつ割り当てる。", "pure": "ひとへやにふたりずつわりあてる", "tr": "按每间房两个人进行分配。", "note": "【N2考点】阅读中常搭配表示基准的「～ずつ」。"}
    ]},
    {"word": "備え付ける", "kana": "そなえつける", "direct_tr": "设置/装备", "usages": [
        {"meaning": "用法①：在特定场所固定安装", "jp": "各部屋にエアコンを備え付けてある。", "pure": "かくへやにエアコンをそなえつけてある", "tr": "每个房间都配备了空调。", "note": "【近义词辨析】与「備える」(防备/具备) 不同，强烈暗示大型物体的物理“安装”。"}
    ]},
    {"word": "打ち合わせる", "kana": "うちあわせる", "direct_tr": "商量/碰头", "usages": [
        {"meaning": "用法①：事前商量细节", "jp": "会議の前に詳細を打ち合わせる。", "pure": "かいぎのまえにしょうさいをうちあわせる", "tr": "会议前商量一下细节。", "note": "【N2考点】名词形式「打ち合わせ」在职场日语中极高频。"}
    ]},
    {"word": "見合わせる", "kana": "みあわせる", "direct_tr": "暂停/推迟/互看", "usages": [
        {"meaning": "用法①：暂停、推迟计划", "jp": "悪天候のため、出発を見合わせる。", "pure": "あくてんこうのため、しゅっぱつをみあわせる", "tr": "因为天气恶劣，推迟出发。", "note": "【N2考点】听力中高频词，听到说明活动取消或延期。"},
        {"meaning": "用法②：互相看着对方", "jp": "二人は顔を見合わせて笑った。", "pure": "ふたりはかおをみあわせてわらった", "tr": "两人面面相觑笑了起来。", "note": "【固定搭配】结合「顔を」使用。"}
    ]},
    {"word": "堪える", "kana": "こたえる", "direct_tr": "吃不消/难受", "usages": [
        {"meaning": "用法①：外在刺激让身心难以忍受", "jp": "この寒さは体に応える。", "pure": "このさむさはからだにこたえる", "tr": "这寒冷真让身体吃不消。", "note": "【N2考点】读音是こたえる，切忌读成たえる(忍耐)。"}
    ]},
    {"word": "補う", "kana": "おぎなう", "direct_tr": "弥补/补充", "usages": [
        {"meaning": "用法①：弥补不足之处", "jp": "経験の不足を努力で補う。", "pure": "けいけんのふそくをどりょくでおぎなう", "tr": "用努力来弥补经验的不足。", "note": "【近义词】「カバーする」，填补空白或弱点。"}
    ]},
    {"word": "廃れる", "kana": "すたれる", "direct_tr": "过时/衰落", "usages": [
        {"meaning": "用法①：风俗或流行消退", "jp": "古い慣習は次第に廃れていく。", "pure": "ふるいかんしゅうはしだいにすたれていく", "tr": "旧习俗渐渐衰落了。", "note": "【近义词辨析】区别于「滅びる」(彻底灭亡)，仅表示不再流行。"}
    ]},
    {"word": "朗らか", "kana": "ほがらか", "direct_tr": "开朗/晴朗", "usages": [
        {"meaning": "用法①：性格阳光", "jp": "彼女は朗らかな性格で人気がある。", "pure": "かのじょはほがらかなせいかくで人気がある", "tr": "她性格开朗很受欢迎。", "note": "【词性】形容动词（～な）。"}
    ]},
    {"word": "妥協", "kana": "だきょう", "direct_tr": "妥协", "usages": [
        {"meaning": "用法①：双方让步达成一致", "jp": "品質については絶対に妥協しない。", "pure": "ひんしつについてはぜったいにだきょうしない", "tr": "在品质上绝对不妥协。", "note": "【固定搭配】妥協を許さない（绝不妥协）。"}
    ]},
    {"word": "執着", "kana": "しゅうちゃく", "direct_tr": "留恋/执着", "usages": [
        {"meaning": "用法①：迷恋事物不肯放弃", "jp": "過去の栄光に執着する。", "pure": "かこのえいこうにしゅうちゃくする", "tr": "执着于过去的辉煌。", "note": "【N2考点】常接助词「～に」。"}
    ]},
    {"word": "漠然", "kana": "ばくぜん", "direct_tr": "模糊/含糊", "usages": [
        {"meaning": "用法①：不清晰，没有具体形态", "jp": "将来に対して漠然とした不安を抱く。", "pure": "しょうらいにたいしてばくぜんとしたふあんをいだく", "tr": "对未来抱有模糊的不安。", "note": "【固定搭配】漠然とした（修饰名词）。"}
    ]},
    {"word": "閲覧", "kana": "えつらん", "direct_tr": "阅读/浏览", "usages": [
        {"meaning": "用法①：查阅资料或网页", "jp": "図書館の貴重な資料を閲覧する。", "pure": "としょかんのきちょうなしりょうをえつらんする", "tr": "查阅图书馆的珍贵资料。", "note": "【N2考点】正式文书用语。"}
    ]},
    {"word": "兆し", "kana": "きざし", "direct_tr": "前兆", "usages": [
        {"meaning": "用法①：事情发生前的迹象", "jp": "景気回復の兆しが見え始めた。", "pure": "けいきかいふくのきざしがみえはじめた", "tr": "开始显现出经济复苏的迹象。", "note": "【常考句型】～の兆しが見える（看到...的前兆）。"}
    ]},
    {"word": "合致", "kana": "がっち", "direct_tr": "一致/吻合", "usages": [
        {"meaning": "用法①：意见、条件等完全符合", "jp": "双方の意見が完全に合致した。", "pure": "そうほうのいけんがかんぜんにがっちした", "tr": "双方的意见完全一致。", "note": "【近义词】「一致する」。"}
    ]}
]
...
l2_words = [
    {"word": "錯覚", "kana": "さっかく", "direct_tr": "错觉/误会", "usages": [
        ...
        {"meaning": "用法②：认知上的自作多情", "jp": "彼が私を好きだと錯覚していた。", "pure": "かれがわたしをすきだとはっかくしていた", "tr": "我产生了他喜欢我的错觉。", "note": "【辨析】用于心理活动，表示想多了。"}
    ]},
    {"word": "察知", "kana": "さっち", "direct_tr": "察觉/感知", "usages": [
        {"meaning": "用法①：提前察觉到危险", "jp": "危険をいち早く察知して避難する。", "pure": "きけんをいちはやくさっちしてひなんする", "tr": "尽早察觉到危险并避难。", "note": "【固定搭配】常接「危険を～」「変化を～」。"}
    ]},
    {"word": "指図", "kana": "さしず", "direct_tr": "指示/命令", "usages": [
        {"meaning": "用法①：以上对下的指手画脚", "jp": "他人からあれこれ指図されるのは不愉快だ。", "pure": "たにんからあれこれさしずされるのはふゆかいだ", "tr": "被别人指手画脚让人很不愉快。", "note": "【N2考点】被动语态「指図される」常用来表达作者的不满。"}
    ]},
    {"word": "自覚", "kana": "じかく", "direct_tr": "自觉/意识到", "usages": [
        {"meaning": "用法①：认识到自己的状态", "jp": "プロとしての自覚が足りない。", "pure": "ぷろとしてのじかくがたりない", "tr": "作为专业人士的自觉性不够。", "note": "【固定搭配】「自覚を持つ」「自覚が足りない」。"}
    ]},
    {"word": "失脚", "kana": "しっきゃく", "direct_tr": "下台/垮台", "usages": [
        {"meaning": "用法①：失去地位", "jp": "スキャンダルが原因で大臣が失脚した。", "pure": "すきゃんだるがげんいんでだいじんがしっきゃくした", "tr": "因为丑闻大臣下台了。", "note": "【考点】新闻日语高频词。"}
    ]},
    ...
    {"word": "借用", "kana": "しゃくよう", "direct_tr": "借用", "usages": [
        {"meaning": "用法①：借用物品或金钱", "jp": "会議室を一時的に借用する。", "pure": "かいぎしつをいちじてきにしゃくようする", "tr": "暂时借用会议室。", "note": "【考点】公文书面语。"}
    ]},
    {"word": "修飾", "kana": "しゅうしょく", "direct_tr": "修饰", "usages": [
        {"meaning": "用法①：语法上的修饰", "jp": "形容詞が名詞を修飾する。", "pure": "けいようしがめいしをしゅうしょくする", "tr": "形容词修饰名词。", "note": "【辨析】区别于「装飾」(物理上的装饰)。"}
    ]},
    {"word": "手記", "kana": "しゅき", "direct_tr": "手记/笔记", "usages": [
        {"meaning": "用法①：亲身经历的记录", "jp": "戦争の体験を手記にまとめる。", "pure": "せんそうのたいけんをしゅきにまとめる", "tr": "将战争的体验整理成手记。", "note": "【固定搭配】手記を残す（留存手记）。"}
    ]},
    {"word": "熟睡", "kana": "じゅくすい", "direct_tr": "熟睡", "usages": [
        {"meaning": "用法①：睡得很深", "jp": "疲れていたので、朝まで熟睡した。", "pure": "つかれていたので、あさまでじゅくすいした", "tr": "因为很累，熟睡到了天亮。", "note": "【近义词】「ぐっすり眠る」。"}
    ]},
    {"word": "出現", "kana": "しゅつげん", "direct_tr": "出现", "usages": [
        {"meaning": "用法①：出乎意料地出现", "jp": "空に未確認の飛行物体が出現した。", "pure": "そらにみかくにんのひこうぶったいがしゅつげんした", "tr": "空中出现了不明飞行物。", "note": "【辨析】带有突然性或神秘感。"}
    ]},
    {"word": "主導", "kana": "しゅどう", "direct_tr": "主导", "usages": [
        {"meaning": "用法①：起带头作用", "jp": "政府が主導して経済改革を進める。", "pure": "せいふがしゅどうしてけいざいかいかくをすすめる", "tr": "由政府主导推进经济改革。", "note": "【固定搭配】主導権を握る（掌握主导权）。"}
    ]},
    {"word": "樹立", "kana": "じゅりつ", "direct_tr": "树立/建立", "usages": [
        {"meaning": "用法①：建立国家或刷新纪录", "jp": "新しい世界記録が樹立された。", "pure": "あたらしいせかいきろくがじゅりつされた", "tr": "树立了新的世界纪录。", "note": "【固定搭配】新記録の樹立。"}
    ]},
    {"word": "奨励", "kana": "しょうれい", "direct_tr": "鼓励/奖励", "usages": [
        {"meaning": "用法①：鼓励做某事", "jp": "会社は資格の取得を奨励している。", "pure": "かいしゃはしかくのしゅとくをしょうれいしている", "tr": "公司鼓励员工考取资格证。", "note": "【辨析】侧重精神上的鼓舞和提倡。"}
    ]},
    {"word": "助言", "kana": "じょげん", "direct_tr": "建议/忠告", "usages": [
        {"meaning": "用法①：给予建议", "jp": "専門家から適切な助言をもらう。", "pure": "せんもんかからてきせつなじょげんをもらう", "tr": "从专家那里获得恰当的建议。", "note": "【近义词】「アドバイス」。"}
    ]}
]


# 【第1课时】150+字 N2 实战原创长文 (聚光灯版)
l1_sentences = [
...
with st.container():
    ...
    with c_mid:
        ...
        if "第2课时" in selected_lesson:
            ...
            with tab_game:
                st.info("💡 温故知新：根据中文选出上节课学过的正确日语单词！答对可解锁发音。")
        ...
        # ------------------------------------------
        # 核心词解剖 (绝对 PPT 分页模式，不滚屏)
        # ------------------------------------------
        with tab_core:
            st.info("💡 提示：为了保护视力，已开启【PPT分页模式】。每页3词，深度掌握多重用法。将鼠标悬停在卡片底部灰色区域可查看无痕翻译。")
            ...
            # 严格截取 3 个词
            if "第1页" in ppt_page: display_words = current_words[0:3]
            elif "第2页" in ppt_page: display_words = current_words[3:6]
            elif "第3页" in ppt_page: display_words = current_words[6:9]
            elif "第4页" in ppt_page: display_words = current_words[9:12]
            else: display_words = current_words[12:15]
